...
axel -aN -n 100 http://images.cocodataset.org/annotations/panoptic_annotations_trainval2017.zip
echo "panoptic_annotations_trainval2017.zip download completed ..."
