...
Tanzila Binti Alam - Repo organization, Imagenet scripts (download & extract), Raw data to Huggingface format, imagenet label files preparation, writing backbone models' configs, imagenet data compression in parquet format, augmentation script
